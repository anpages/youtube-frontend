...
export function renderHeader(currentPath = '/') {
  ...
  if (subnav) {
    subnav.className = (authed && currentPath !== '/watch') ? 'sticky top-0 z-50 bg-neutral-950/95 backdrop-blur-sm border-b border-neutral-800' : ''
    subnav.innerHTML = (authed && currentPath !== '/watch') ? `
